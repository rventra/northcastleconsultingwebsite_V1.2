...
const RoundupClaimantCommunicationSMSBridgeThankYou = () => {
  ...
  const handleBackClick = (e) => {
    e.preventDefault();
    navigate('/roundup-claimant-communication-sms-bridge');
  };
  ...
  return (
    <>
      <PageMeta pageKey="roundupSMSBridgeThankYou" />
      <div className="min-h-screen flex flex-col bg-white font-['Georgia','Times_New_Roman',serif] text-[#2C2C2C]">
        ...
        <main className="flex-1 flex flex-col items-center justify-center py-16 px-6 pb-10 text-center">
          ...
          <p className="text-[17px] text-[#5A5A5A] max-w-[540px] mx-auto mb-2 leading-relaxed">
            Your SMS Bridge pilot request has been received. Our team will reach out within 24 hours to coordinate your claimant data transfer and begin deploying your free 100-claimant SMS Bridge.
          </p>
          ...
          <div className="bg-[#FAF5EB] border-2 border-[#C8973E] rounded-[10px] py-8 px-9 max-w-[520px] w-full mb-10 text-center">
            ...
            <h2 className="text-[22px] text-[#0B1D3A] mb-2.5 leading-snug">
              Plan Your Full-Docket SMS Deployment
            </h2>
            <p className="font-sans text-[14px] text-[#5A5A5A] mb-5 leading-snug">
              The pilot covers 100 claimants. On a 30-minute call, we'll review your full Roundup docket and plan the complete SMS Bridge deployment—before the SCOTUS deadline closes your window.
            </p>
            <a 
...
export default RoundupClaimantCommunicationSMSBridgeThankYou;
