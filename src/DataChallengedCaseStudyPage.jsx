    ...
    <div className="pt-16">
      ...
      <div className="bg-gray-100 py-4 px-6 border-b border-gray-200">
        <div className="max-w-5xl mx-auto flex flex-wrap gap-6 text-sm">
          <div><span className="text-gray-500">Industry:</span> <span className="font-medium text-[#1e3a5f]">Business Services (Vending & Catering)</span></div>
          <div><span className="text-gray-500">Team:</span> <span className="font-medium text-[#1e3a5f]">1 Vice President</span></div>
          <div><span className="text-gray-500">Services:</span> <span className="font-medium text-[#1e3a5f]">Sell-Side Readiness, FP&A, Transaction DD</span></div>
        </div>
      </div>
        ...
        <div className="bg-gray-50 py-10 px-6 md:px-10">
          <div className="max-w-md ml-auto">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> Understaffed finance department</li>
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> Fragmented legacy systems</li>
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> Incomplete post-acquisition integrations</li>
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> Unable to present confidently to market</li>
            </ul>
          </div>
        </div>
      ...
      <div className="py-10 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-lg font-bold text-[#1e3a5f] mb-6">Six Targeted Analytical Initiatives</h2>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-[#1e3a5f] text-sm">Successful Exit</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-[#1e3a5f] text-sm">Bank Focus Restored</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-[#1e3a5f] text-sm">Efficient Diligence</span>
              </div>
