    ...
    <div className="pt-20">
      ...
      <div className="bg-gray-100 py-4 px-6 border-b border-gray-200">
        <div className="max-w-5xl mx-auto flex flex-wrap gap-6 text-sm">
          <div><span className="text-gray-500">Industry:</span> <span className="font-medium text-slate-900">Manufacturing (Auto Parts)</span></div>
          <div><span className="text-gray-500">Team:</span> <span className="font-medium text-slate-900">1 MD, 1 Director, 1 VP</span></div>
          <div><span className="text-gray-500">Services:</span> <span className="font-medium text-slate-900">Sell-Side Readiness, Transaction DD</span></div>
        </div>
      </div>
        ...
        <div className="bg-gray-50 py-10 px-6 md:px-10">
          <div className="max-w-md ml-auto">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex gap-2"><span className="text-blue-900">•</span> 2.7 million transaction-level data points</li>
              <li className="flex gap-2"><span className="text-blue-900">•</span> Six disparate ERP systems</li>
              <li className="flex gap-2"><span className="text-blue-900">•</span> No consolidated view of sales, margin, or KPIs</li>
              <li className="flex gap-2"><span className="text-blue-900">•</span> Inability to respond to buyer inquiries</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-blue-900 py-10 px-6 md:px-10 text-white">
          <div className="max-w-md mr-auto">
            ...
            <ul className="space-y-2 text-sm text-blue-100">
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Customer churn analysis</li>
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Price-volume mix by SKU</li>
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Sales/profitability by customer, channel, category</li>
              <li className="flex gap-2"><span className="text-yellow-500">•</span> SKU vintage performance tracking</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-slate-900 text-sm">Competitive Sale Process</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-slate-900 text-sm">Future-Ready Analytics</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-slate-900 text-sm">Ongoing Engagement</span>
              </div>
