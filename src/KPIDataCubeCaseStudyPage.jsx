        ...
        <div className="bg-gray-50 py-10 px-6 md:px-10">
          <div className="max-w-md ml-auto">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex gap-2"><span className="text-[#0D3BC3]">•</span> 2.7 million transaction-level data points</li>
              <li className="flex gap-2"><span className="text-[#0D3BC3]">•</span> Six disparate ERP systems</li>
              <li className="flex gap-2"><span className="text-[#0D3BC3]">•</span> No consolidated view of sales, margin, or KPIs</li>
              <li className="flex gap-2"><span className="text-[#0D3BC3]">•</span> Inability to respond to buyer inquiries</li>
            </ul>
          </div>
        </div>
