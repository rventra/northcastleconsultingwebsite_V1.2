      ...
      <section className="py-16 md:py-20 px-6 bg-[#F6F7F7]">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link to="/case-studies/corporate-operations-to-ownership" className="group block bg-white p-6 rounded-xl border border-slate-200 hover:border-[#0D3BC3]/40 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-[#1A2234]/70 text-sm leading-relaxed mb-3">Enabling executives to acquire a car rental franchise</p>
              <div className="text-xs text-gray-500 space-y-1">
                <div><span className="font-medium">Industry:</span> Travel & Car Rental</div>
