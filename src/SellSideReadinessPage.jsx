        ...
        <div className="grid lg:grid-cols-12 min-h-[600px] lg:min-h-[700px]">
          ...
          <div className="lg:col-span-4 bg-[#F5F5F5] p-8 md:p-10 lg:p-12 flex flex-col justify-center">
            ...
            <div className="space-y-6">
              {obstacles.map((item) => (
                <div key={item.num} className="border-l-2 border-[#051c2c] pl-5">
      ...
      <div className="py-20 md:py-28 px-6 bg-[#F9F9F7]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {valueAdds.map((item) => (
              <div key={item.title} className="bg-white p-8 border-t-4 border-[#051c2c] shadow-sm">
              ...
              <div key={scenario.label} className="bg-[#051c2c] text-white p-10 md:p-14">
                <div className="grid md:grid-cols-12 gap-10">
                  ...
                  <div className="md:col-span-5">
                    <span className="inline-block text-xs font-bold tracking-widest uppercase bg-white text-[#051c2c] px-4 py-2 mb-6">
                      {scenario.label}
                    </span>
