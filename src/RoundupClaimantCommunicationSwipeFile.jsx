...
const RoundupClaimantCommunicationSwipeFile = () => {
  ...
  return (
    <>
      <PageMeta pageKey="roundupSwipeFile" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white border border-[#E8E6E1] rounded-lg overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.08)] relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-[25deg] font-sans text-[36px] font-extrabold text-[rgba(200,151,62,0.08)] uppercase tracking-[0.1em] pointer-events-none whitespace-nowrap">Sample View</div>
                <div className="bg-[#0B1D3A] text-white py-3.5 px-5 font-sans text-[12px] font-bold tracking-[0.06em] uppercase">Claimant Communication Dashboard</div>
                <div className="p-5">
                  <div className="font-sans text-[10px] font-bold uppercase tracking-[0.08em] text-[#6B7B8D] mb-2.5">Campaign Performance</div>
                  
                  <div className="grid grid-cols-3 gap-2.5 mb-4">
                    <div className="text-center py-2.5 px-2 bg-[#F7F5F0] rounded">
                      <span className="font-sans text-lg font-bold text-[#0B1D3A] block">68%</span>
                      <span className="font-sans text-[10px] uppercase tracking-[0.06em] text-[#5A5A5A]">SMS Open Rate</span>
                    </div>
                    <div className="text-center py-2.5 px-2 bg-[#F7F5F0] rounded">
                      <span className="font-sans text-lg font-bold text-[#0B1D3A] block">42%</span>
                      <span className="font-sans text-[10px] uppercase tracking-[0.06em] text-[#5A5A5A]">Response Rate</span>
                    </div>
                    <div className="text-center py-2.5 px-2 bg-[#F7F5F0] rounded">
                      <span className="font-sans text-lg font-bold text-[#0B1D3A] block">3.2 hrs</span>
                      <span className="font-sans text-[10px] uppercase tracking-[0.06em] text-[#5A5A5A]">Avg Response Time</span>
                    </div>
                  </div>
                  
                  <div className="font-sans text-[10px] font-bold uppercase tracking-[0.08em] text-[#6B7B8D] mb-2.5">Active Message Templates</div>
                  <table className="w-full font-sans text-[11px]">
                    <thead>
                      <tr className="text-left">
                        <th className="py-1.5 px-2 font-bold text-[#0B1D3A] border-b-2 border-[#E8E6E1] uppercase tracking-[0.04em] text-[10px]">Template</th>
                        <th className="py-1.5 px-2 font-bold text-[#0B1D3A] border-b-2 border-[#E8E6E1] uppercase tracking-[0.04em] text-[10px]">Type</th>
                        <th className="py-1.5 px-2 font-bold text-[#0B1D3A] border-b-2 border-[#E8E6E1] uppercase tracking-[0.04em] text-[10px]">Usage</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#5A5A5A]">PFS Reminder</td><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#5A5A5A]">SMS</td><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#C8973E] font-semibold">847 sent</td></tr>
                      <tr><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#5A5A5A]">Med Record Auth</td><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#5A5A5A]">Email</td><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#C8973E] font-semibold">623 sent</td></tr>
                      <tr><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#5A5A5A]">Settlement Update</td><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#5A5A5A]">SMS</td><td className="py-1 px-2 border-b border-[#F0EDE6] text-[#C8973E] font-semibold">412 sent</td></tr>
                    </tbody>
                  </table>
                  
                  <div className="mt-4 p-3 bg-[#F0EDE6] rounded">
                    <div className="font-sans text-[10px] font-bold uppercase tracking-[0.06em] text-[#6B7B8D] mb-1">Sample SMS Template</div>
                    <p className="text-[12px] text-[#2C2C2C] italic">
                      &ldquo;[Firm Name]: Hi [First Name], this is [Attorney] from your Roundup legal team. We need to update your Plaintiff Fact Sheet for the settlement. Takes 5 mins. Reply READY or call [Number].&rdquo;
                    </p>
                  </div>
                  <div className="font-sans text-[10px] text-[#6B7B8D] mt-2.5 text-center italic">… 20+ additional templates included</div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-0">
            <details className="border-b border-[#E8E6E1] py-5 group">
              <summary className="text-base font-semibold text-[#0B1D3A] cursor-pointer font-sans list-none flex justify-between items-center">
                How quickly can I start using these Roundup templates?
                <span className="text-[#C8973E] text-[22px] group-open:hidden">+</span>
                <span className="text-[#C8973E] text-[22px] hidden group-open:block">&minus;</span>
              </summary>
              <p className="mt-3 text-[14px] text-[#5A5A5A] leading-relaxed">
                Templates are delivered via email within 24 hours of your request. Each template is ready to use
                immediately—just customize with your firm name and case-specific details. Most firms begin
                deploying the PFS reminder sequences within 48 hours.
              </p>
            </details>
            
            <details className="border-b border-[#E8E6E1] py-5 group">
              <summary className="text-base font-semibold text-[#0B1D3A] cursor-pointer font-sans list-none flex justify-between items-center">
                Are these templates compliant with ABA guidelines?
                <span className="text-[#C8973E] text-[22px] group-open:hidden">+</span>
                <span className="text-[#C8973E] text-[22px] hidden group-open:block">&minus;</span>
              </summary>
              <p className="mt-3 text-[14px] text-[#5A5A5A] leading-relaxed">
                Yes. All templates have been reviewed for compliance with ABA attorney-client text messaging
                guidelines, including proper identification of the sender, opt-out language, and confidentiality
                protections. However, we recommend having your firm&apos;s compliance team review before deployment
                to ensure alignment with your specific jurisdiction&apos;s requirements.
              </p>
            </details>
            
            <details className="border-b border-[#E8E6E1] py-5 group">
              <summary className="text-base font-semibold text-[#0B1D3A] cursor-pointer font-sans list-none flex justify-between items-center">
                How Roundup-specific are the templates?
                <span className="text-[#C8973E] text-[22px] group-open:hidden">+</span>
                <span className="text-[#C8973E] text-[22px] hidden group-open:block">&minus;</span>
              </summary>
              <p className="mt-3 text-[14px] text-[#5A5A5A] leading-relaxed">
                Every template is purpose-built for Roundup NHL litigation. Medical record authorization requests
                specifically reference NHL subtypes (DLBCL, follicular lymphoma, CLL). Exposure documentation
                language mentions glyphosate and Roundup use patterns. Settlement communications reference
                the tiered scoring grid and opt-in requirements unique to the $7.25B settlement.
              </p>
            </details>
            
            <details className="border-b border-[#E8E6E1] py-5 group">
              <summary className="text-base font-semibold text-[#0B1D3A] cursor-pointer font-sans list-none flex justify-between items-center">
                Will these work with our existing CRM or case management system?
                <span className="text-[#C8973E] text-[22px] group-open:hidden">+</span>
                <span className="text-[#C8973E] text-[22px] hidden group-open:block">&minus;</span>
              </summary>
              <p className="mt-3 text-[14px] text-[#5A5A5A] leading-relaxed">
                The templates are provided in plain text format, making them compatible with any CRM or case
                management system—Salesforce, Litify, Filevine, CaseMetrix, and others. Simply copy and paste
                into your platform&apos;s messaging module. Variable fields are marked with brackets [like this]
                for easy mail-merge integration.
              </p>
            </details>
            
            <details className="border-b border-[#E8E6E1] py-5 group">
              <summary className="text-base font-semibold text-[#0B1D3A] cursor-pointer font-sans list-none flex justify-between items-center">
                How much does the full automated communication service cost?
                <span className="text-[#C8973E] text-[22px] group-open:hidden">+</span>
                <span className="text-[#C8973E] text-[22px] hidden group-open:block">&minus;</span>
              </summary>
              <p className="mt-3 text-[14px] text-[#5A5A5A] leading-relaxed">
                The swipe file itself is completely free. For firms interested in fully automated communication
                services—including enriched contact data, automated campaign deployment, and response tracking—
                we scope pricing based on docket size. Most firms see ROI within 30 days through recovered
                claimants and reduced paralegal hours.
              </p>
            </details>
            
            <details className="border-b border-[#E8E6E1] py-5 group">
              <summary className="text-base font-semibold text-[#0B1D3A] cursor-pointer font-sans list-none flex justify-between items-center">
                Is our claimant data secure?
                <span className="text-[#C8973E] text-[22px] group-open:hidden">+</span>
                <span className="text-[#C8973E] text-[22px] hidden group-open:block">&minus;</span>
              </summary>
              <p className="mt-3 text-[14px] text-[#5A5A5A] leading-relaxed">
        ...
        <section className="bg-[#0B1D3A] text-white text-center py-14 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-[#8DA0BF] max-w-xl mx-auto mb-7 text-base">
              The difference between a settled Roundup case and a closed one is often just a text message.
              Download the Roundup NHL templates your team can deploy tomorrow—before the opt-in window closes.
            </p>
            <button 
              onClick={openModal}
...
export default RoundupClaimantCommunicationSwipeFile;
