...
export default function RoundupLandingPage() {
  ...
  return (
    <div>
      {/* Breaking News Timeline Bar - Compact Urgency Header */}
      <div className="bg-[#051c2c] text-white py-2 px-4 border-b-2 border-[#EDB624]">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2 text-xs md:text-sm">
          <div className="flex items-center gap-3 overflow-x-auto">
            <span className="bg-[#EDB624] text-[#051c2c] px-2 py-0.5 font-bold text-xs uppercase tracking-wider whitespace-nowrap">Breaking</span>
            <span className="text-white/60 whitespace-nowrap">Feb 17:</span>
            <span className="font-semibold whitespace-nowrap">$7.25B Settlement Filed</span>
            <span className="text-white/40">|</span>
            <span className="text-[#EDB624] font-bold whitespace-nowrap">{daysUntilScotus} days</span>
            <span className="text-white/60 whitespace-nowrap">until SCOTUS arguments</span>
            <span className="text-white/40 hidden sm:inline">|</span>
            <span className="text-white/60 whitespace-nowrap hidden sm:inline">Q3 2026: Opt-in deadline</span>
          </div>
          <button onClick={openModal} className="text-[#EDB624] hover:underline font-semibold whitespace-nowrap text-xs">
            Get 100-case sample report →
          </button>
        </div>
      </div>
      ...
      <section id="hero" className="grid lg:grid-cols-2 min-h-[650px]">
        ...
        <div className="bg-[#334155] flex flex-col justify-center p-8 md:p-12 lg:p-16">
          <div className="max-w-md mx-auto w-full">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4 pb-5 border-b border-white/10">
                <div className="w-10 h-10 rounded-full bg-[#EDB624]/20 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-white font-bold text-sm mb-1">AI-Powered Tier Analysis</p>
                  <p className="text-white/50 text-sm leading-relaxed">Map cases to settlement scoring criteria in days, not weeks</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pb-5 border-b border-white/10">
                ...
                <div>
                  <p className="text-white font-bold text-sm mb-1">Claimant Re-Engagement</p>
                  <p className="text-white/50 text-sm leading-relaxed">Locate lost claimants and revive cases before opt-in deadlines</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-white font-bold text-sm mb-1">Documentation Remediation</p>
                  <p className="text-white/50 text-sm leading-relaxed">Close gaps that downgrade cases from $150K+ to under $10K</p>
                </div>
              </div>
            </div>
