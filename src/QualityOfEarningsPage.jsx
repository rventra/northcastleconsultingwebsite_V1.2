      ...
      <div className="pt-8">
        <div className="grid lg:grid-cols-12 min-h-[700px] lg:min-h-[800px]">
              ...
              <div className="p-6 md:p-10 lg:p-12 w-full">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-white font-bold text-base">SOC 2 Compliant</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">Track progress & files</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="w-6 h-6 text-[#EDB624] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <p className="text-white font-bold text-base">Audit Logs</p>
                      <p className="text-white/60 text-sm">Complete access tracking</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-4 bg-[#F5F5F5] p-8 md:p-10 lg:p-12">
            ...
            >
              <span>Download QoE Guide (PDF)</span>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
