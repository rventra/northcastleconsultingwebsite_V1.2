      ...
      <div className="pt-8">
        <div className="grid lg:grid-cols-12 min-h-[700px] lg:min-h-[800px]">
          ...
          <div className="lg:col-span-8 relative flex flex-col">
            ...
            <div className="relative h-1/2 min-h-[350px] bg-[#475569] flex items-center">
              <div className="p-6 md:p-10 lg:p-12 w-full">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#EDB624] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <div>
                      <p className="text-white font-semibold text-sm">SOC 2 Compliant</p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-xs">Track progress & files</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <svg className="w-5 h-5 text-[#EDB624] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-xs">Complete access tracking</p>
                    </div>
                  </div>
                </div>
                
                <p className="text-white/80 text-sm mb-6 leading-relaxed">
                  Secure AWS infrastructure with complete audit trails. Upload, download, and track your files through our client portal. Every access logged, every action traceable.
                </p>
