    ...
    <div className="pt-20">
      ...
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300">FinTech Payments | Sell-Side Readiness</p>
        </div>
      </div>
      ...
      <div className="py-16 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Structuring Key Growth & Churn Analysis for a FinTech Sale</h2>

            <div className="bg-gray-50 rounded-2xl p-8 mb-8 border-l-4 border-blue-900">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 group-hover:text-blue-900 mb-2">Building Credibility & Justifying Multiples</h3>
