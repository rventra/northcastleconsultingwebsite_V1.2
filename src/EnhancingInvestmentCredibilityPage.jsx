    ...
    <div className="pt-20">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex gap-4 text-center">
              ...
              <div className="bg-white/10 rounded-lg px-4 py-3">
                <p className="text-yellow-500 text-xl font-bold">4</p>
      ...
      <div className="bg-gray-100 py-4 px-6 border-b border-gray-200">
        <div className="max-w-5xl mx-auto flex flex-wrap gap-6 text-sm">
          <div><span className="text-gray-500">Industry:</span> <span className="font-medium text-slate-900">FinTech (Payments)</span></div>
          <div><span className="text-gray-500">Team:</span> <span className="font-medium text-slate-900">1 MD, 1 Director, 1 VP, 1 Associate</span></div>
        ...
        <div className="bg-gray-50 py-10 px-6 md:px-10">
          <div className="max-w-md ml-auto">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex gap-2"><span className="text-blue-900">•</span> No clear explanation for revenue growth</li>
              <li className="flex gap-2"><span className="text-blue-900">•</span> Customer retention unclear</li>
              <li className="flex gap-2"><span className="text-blue-900">•</span> Sales pipeline effectiveness unknown</li>
              <li className="flex gap-2"><span className="text-blue-900">•</span> Sponsor couldn't align internal teams</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-blue-900 py-10 px-6 md:px-10 text-white">
          <div className="max-w-md mr-auto">
            ...
            <ul className="space-y-2 text-sm text-blue-100">
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Key growth driver analysis</li>
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Sales pipeline & win rate analysis</li>
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Customer churn & retention analysis</li>
              <li className="flex gap-2"><span className="text-yellow-500">•</span> Revenue/issuance data cube</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="py-10 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-lg font-bold text-slate-900 mb-6">Building the Data Foundation</h2>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-slate-900 text-sm">Stronger Thesis</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-slate-900 text-sm">Confident Answers</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-slate-900 text-sm">Smooth Process</span>
              </div>
