    ...
    <div className="pt-16">
      ...
      <div className="bg-gray-100 py-4 px-6 border-b border-gray-200">
        <div className="max-w-5xl mx-auto flex flex-wrap gap-6 text-sm">
          <div><span className="text-gray-500">Industry:</span> <span className="font-medium text-[#1e3a5f]">Leisure & Hospitality (Venue Management)</span></div>
          <div><span className="text-gray-500">Team:</span> <span className="font-medium text-[#1e3a5f]">1 Director, 1 VP</span></div>
          <div><span className="text-gray-500">Services:</span> <span className="font-medium text-[#1e3a5f]">Sell-Side Readiness, FP&A Support</span></div>
        </div>
      </div>
        ...
        <div className="bg-gray-50 py-10 px-6 md:px-10">
          <div className="max-w-md ml-auto">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> Finance team overwhelmed with basic analysis</li>
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> CFO and sponsor distracted from strategy</li>
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> High EBITDA multiple needed data justification</li>
              <li className="flex gap-2"><span className="text-[#1e3a5f]">•</span> Buyers questioning contract strength</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-[#1e3a5f] py-10 px-6 md:px-10 text-white">
          <div className="max-w-md mr-auto">
            ...
            <ul className="space-y-2 text-sm text-blue-100">
              <li className="flex gap-2"><span className="text-amber-300">•</span> Contract leverage & negotiation analysis</li>
              <li className="flex gap-2"><span className="text-amber-300">•</span> Cap Ex ROI & lease obligations analysis</li>
              <li className="flex gap-2"><span className="text-amber-300">•</span> Operational improvement benchmarking</li>
              <li className="flex gap-2"><span className="text-amber-300">•</span> Venue performance before/after analysis</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="py-10 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-lg font-bold text-[#1e3a5f] mb-6">Three Critical Analyses</h2>
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <h3 className="text-sm font-bold text-[#1e3a5f] mb-2">{step.title}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-[#1e3a5f] text-sm">Premium Exit</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-[#1e3a5f] text-sm">Management Focus</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-green-500">✓</span>
                <span className="font-medium text-[#1e3a5f] text-sm">Lasting Value</span>
              </div>
