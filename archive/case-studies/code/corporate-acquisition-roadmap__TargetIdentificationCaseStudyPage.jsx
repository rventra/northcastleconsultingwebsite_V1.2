  ...
  return (
    <div className="pt-16">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('https://images.squarespace-cdn.com/content/v1/67a3d67b7ec4550695844db8/1741738068173-OFGOTPZGCUD0UQ05C3QO/unsplash-image-FVwG5OzPuzo.jpg?format=2500w')`
        }}
      >
        {/* Subtle Blue Overlay */}
